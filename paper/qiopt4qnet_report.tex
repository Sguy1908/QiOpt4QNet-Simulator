...
feasibility gains are $+3.46$ pp (SA) and $+5.98$ pp (SQA).  The
...
$=18$ paired comparisons and apply no multiplicity correction, so about
one interval in twenty would be expected to exclude zero by chance.
