...
% TODO: insert the full-cohort independent-reads budget table (1,078 instances,
% SA, reads 10 vs 100, 10x sweeps, seeds 101 and 202) from
% QNet_Sim/results/penalty_calibration/budget_sensitivity_summary.csv once the run completes.
